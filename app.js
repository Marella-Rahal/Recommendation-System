...
app.get("/", (req, res) => {
    ...
    var matrix=[
        [1,2,3,1.5,3.5,0,0,0,0,5,1.5,2.5,0,0,4.5,0,0,0,0,0],
        [1.5,2,3,1.5,3,0,2.5,0,0,5,1,2,0,0,4.5,1.5,0,1,0,0],
        [1,2,3,4,5,2,0,0,0,1.5,1.5,2.5,0,0,4.5,0,3.5,0,2,0],
        [1,2.5,3,1,3.5,0,2,0,0,5,1.5,2,0,0,4.5,0,3,0,0,0],
        [1.5,2,3.5,1.5,3,0,3,0,0,2,1,2.5,0,0,4.5,0,2,0,0,5],
